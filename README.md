...
## Introduction
Throughout my course work in the Computer Science program, I have been able to build upon each new learning experience. Even while completing this ePortfolio, I was able to see how far I have progressed since my first computer science class. I have been able to work in several programming languages such as Java, C, C++, Python and SQL.  I was able to take an application from conception to completion.  This program has also shown me what goes into planning/designing, creating, maintaining and securing software within the software development life cycle.  The program allowed me to see that a good programmer will develop a plan with pseudocode before actually coding.  They will also develop their code into smaller chunks.  This incremental process allows them to review and test to make sure that their program is working before moving onto the next snippet of code.  Here are some of the most important concepts that I have learned so far: 

- For my Data Structures and Algorithms class, I was able to learn how data is structured (such as in linked lists, arrays or hash maps) and to see how that data can be accessed effectively through efficient algorithmic methods.  There are many algorithms available such as quicksort and binary search, to name a few, that can provide alternative ways to retrieve data information.  The key is to find the right algorithm that can both effectively and efficiently solve the problem at hand.
...
- With my database design and structure class, I was able to figuratively look behind the scenes of my current employer's warehouse relational database system. I learned how databases are first conceptualized and then planned by mapping how tables and their entities will relate to each other prior to any data being stored.  I would consider this one of the most important concepts to grasp since almost everyone interacts with some type of database everyday.   

- Another concept which is vital for every programmer to keep in mind is to make sure that their code is secure or keeping security at the forefront of any design process. Vulnerability issues can result from problems such as buffer overflows and non-existent error handling.  The way to prevent these issues is to follow coding best practices.   

- The importance of collaboration within a team environment was also key to successfully completing assignments and/or projects.  All of my classmates lived in different regions of the country which made effective communication all the more important.  Being able to communicate and share with other team members not only can provide a higher quality outcome for an application, but it can also expand the knowledge base for the whole group.
