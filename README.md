...
## Introduction
Throughout my course work in the Computer Science program, I have been able to build upon each new learning experience. Even while completing this ePortfolio, I was able to see how far I have progressed since my first computer science class. I have been able to work in several programming languages such as Java, C, C++, Python and SQL.  I was able to take an application from concept to completion.  This program has also shown me what goes into planning/designing, creating, maintaining and securing software within the software development life cycle.  The program allowed me to see that a good programmer will develop a plan with pseudocode before actually coding.  They will also develop their code into smaller chunks.  This incremental process allows them to review and test to make sure that their program is working before moving onto the next snippet of code.  Here are some of the most important concepts that I have learned so far: 
